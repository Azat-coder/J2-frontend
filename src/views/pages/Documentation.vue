...
<code>import { useLayout } from '@/layout/composables/layout';</code></pre>
        ...
        <ul class="leading-normal list-disc pl-8 text-lg mb-4">
            ...
            <li><span class="text-primary font-medium">src/entities</span> <i class="pi pi-arrow-right !text-sm mr-1"></i> <span class="text-primary font-medium">components</span></li>
